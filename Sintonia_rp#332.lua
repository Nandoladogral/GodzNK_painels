...
_G.BtnMinimizarGodz.Font = Enum.Font.SourceSansBold
...
tabsScroll.CanvasSize = UDim2.new(2.0, 0, 0, 0)
...
_G.StatusLabelGodz.Font = Enum.Font.SourceSansBold
_G.StatusLabelGodz.TextSize = 13
...
tpLayout.Parent = _G.TpScrollFrameGodz
...
_G.BtnToggleHealthGodz = criarBotaoAcao("BtnToggleHealth", "ESP BARRA DE VIDA: ATIVADO", Color3.fromRGB(46, 204, 113), _G.EspHealthTrack and _G.EspScrollFrameGodz)
...
ViewTextBox.TextSize = 13
ViewTextBox.Font = Enum.Font.SourceSansBold
...
local function resetarCoresAbas()
...
_G.BtnToggleBoxGodz.MouseButton1Click:Connect(function()
    _G.EspBoxTrack = not _G.EspBoxTrack
    atualizarInterface()
end)
_G.BtnToggleSkeletonGodz.MouseButton1Click:Connect(function()
    _G.EspSkeletonTrack = not _G.EspSkeletonTrack
    atualizarInterface()
end)
_G.BtnToggleNameGodz.MouseButton1Click:Connect(function()
    _G.EspNameTrack = not _G.EspNameTrack
    atualizarInterface()
end)
_G.BtnToggleHealthGodz.MouseButton1Click:Connect(function()
    _G.EspHealthTrack = not _G.EspHealthTrack
    atualizarInterface()
end)
...
_G[SpeedConnectionName] = RunService.RenderStepped:Connect(function(deltaTime)
    if not screenGui or not screenGui.Parent then
        _G.SecureSpeedLoop = false; _G.SecureRenderLoop = false; _G.CameraViewActive = false
        pcall(function() RunService:UnbindFromRenderStep("GodzESP_Render") end)
